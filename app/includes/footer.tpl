<section class="pre-footer">
  <div class="container">
    <p>
      wallet.ether1.org does not hold your keys for you. We cannot access accounts, recover keys, reset passwords, nor reverse transactions. Protect your keys &amp; always check that you are on correct URL.
...
<footer class="footer" role="content" aria-label="footer" ng-controller='footerCtrl' >
  ...
  <article class="block__wrap" style="max-width: 1780px; margin: auto;">
    ...
    <section class="footer--left">
      ...
      <a href="/"><img src="images/myetherwallet-logo.png" height="45px" width="auto" alt="ETHO Wallet" class="footer--logo"/></a>
    ...
    <section class="footer--righ">
      ...
      <p>
        ...
        <a aria-label="github" title="github" href="https://github.com/Ether1Project" target="_blank" rel="noopener noreferrer" role="link" tabindex="0">
        ...
        <a aria-label="support email" title="support email" href="mailto:admin@ether1.org" target="_blank" rel="noopener noreferrer" role="link" tabindex="0">
