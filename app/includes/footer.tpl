<section class="pre-footer">
  <div class="container">
    <p>
      wallet.xerom.org does not hold your keys for you. We cannot access accounts, recover keys, reset passwords, nor reverse transactions. Protect your keys &amp; always check that you are on correct URL.
...
<footer class="footer" role="content" aria-label="footer" ng-controller='footerCtrl' >
  ...
  <article class="block__wrap" style="max-width: 1780px; margin: auto;">
    ...
    <section class="footer--left">
      ...
      <a href="/"><img src="images/myetherwallet-logo.png" height="45px" width="auto" alt="XERO Wallet" class="footer--logo"/></a>
    ...
    <section class="footer--righ">
      ...
      <p>
        <a aria-label="twitter" title="twitter" href="https://twitter.com/XeromOfficial" target="_blank" rel="noopener noreferrer" role="link" tabindex="0">
        ...
        <a aria-label="github" title="github" href="https://github.com/xero-official" target="_blank" rel="noopener noreferrer" role="link" tabindex="0">
        ...
        <a aria-label="support email" title="support email" href="mailto:admin@xerom.org" target="_blank" rel="noopener noreferrer" role="link" tabindex="0">
