...
ERROR_35                        :  '(error_36) Input address is not checksummed. <a href="https://kb.myetherwallet.com/addresses/what-does-checksummed-mean.html" target="_blank" rel="noopener noreferrer">What does that mean?</a>',
...
TXFEE_Desc                      :  'The TX Fee is paid to miners for including your TX in a block. Is is the `gas limit` * `gas price`. [You can convert GWEI -> ETH here](https://wallet.xerom.org/helpers.html)',
...
HELP_4_Desc_2                   :  'Navigate to the "Send XERO & Tokens" page.',
...
HELP_4CX_Desc_1                 :  'First, you need to add a wallet. Once you have done that, you have 2 options: the "QuickSend" functionality from the Chrome Extension icon or the "Send XERO & Tokens" page.',
HELP_4CX_Desc_10                :  'Enter the password for that wallet.',
HELP_4CX_Desc_11                :  'Click "Send Transaction."',
HELP_4CX_Desc_12                :  'Using "Send XERO & Tokens" Page',
...
HELP_7_Desc_1                   :  'Navigate to the "Send XERO & Tokens" page.',
...
HELP_9_Title                    :  '9) Is the "Send XERO & Tokens" page offline?',
