...
EOS_06                          :  'Go to Send XERO & Tokens Page',
...
ONBOARD_secure_1_content__3     :  'Always check the URL: `https://wallet.xerom.org`.',
...
ERROR_27                        :  '(error_28) برای دسترسی به این کیف پول در آینده به فایل Keystore و رمزعبور خود (یا کلید خصوصی) نیاز خواهید داشت. لطفا آن را ذخیره کنید و یک نسخه پشتیبان خارجی بسازید. اگر آن را ذخیره نکنید، هیچ راهی برای بازگرداندن کیف پول وجود ندارد. برای راهنمایی [صفحه کمک](https://wallet.xerom.org/#help)  را مطالعه بفرمایید. Minimum amount: 0.01. Max amount:', // 27
...
HELP_Sec_Desc_4: 'این سایت از طریق GitHub ارائه می شود، می توانید کد اصلی یا Source Code آن را در این آدرس ببینید:  [https://github.com/kvhnuke/etherwallet/tree/gh-](https://github.com/kvhnuke/etherwallet/tree/gh-pages) و [https://wallet.xerom.org](https://wallet.xerom.org). ',
